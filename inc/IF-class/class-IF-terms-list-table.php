...
require_once dirname(__FILE__) . "/../../../../../wp-admin/includes/class-wp-terms-list-table.php";

class  IF_Terms_List_Table extends WP_Terms_List_Table {
	...
	function _rows( $taxonomy, $terms, &$children, $start = 0, $per_page = 20, &$count, $parent = 3, $level = 0 ) {
